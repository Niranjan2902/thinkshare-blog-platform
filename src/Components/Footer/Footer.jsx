...
function Footer() {
    return (
      <section className="relative overflow-hidden py-10 bg-gradient-to-r from-indigo-500 to-purple-600 border border-t-2 border-t-black">
                  ...
                  <div className="-m-6 flex flex-wrap">
                      <div className="w-full p-6 md:w-1/2 lg:w-5/12">
                          <div className="flex h-full flex-col justify-between">
                                ...
                                <div className="social-wrapper">
                                    <ul className="example-2">
                                        ...
                                        <a href="https://instagram.com/" aria-label="Instagram" data-social="instagram">
                                            ...
                                            3.9 0 0 0-.923-1.417A3.9 3.9 
                                            0 0 0 13.24.42c-.51-.198-1.092-.333-1.943-.372C10.443.01 
                                            ...
                                            2.5 0 0 1-.92-.598 2.5 2.5 
                                            0 0 1-.6-.92c-.109-.281-.24-.705-.275-1.485-.038-.843-.046-1.096-.046-3.233s.008-2.388.046-3.231c.036-.78.166-1.204.276-1.486.145-.373.319-.64.599-.92s.546-.453.92-.598c.282-.11.705-.24 
                                            1.485-.276.738-.034 1.024-.044 
                                            2.515-.045zm4.988 2.144a.96.96 
                                            0 1 1-1.92 0 .96.96 0 0 1 1.92 
                                            0zM8 3.923a4.077 4.077 0 1 
                                            0 0 8.154 4.077 4.077 0 0 0 0-8.154zm0 
                                            6.712a2.635 2.635 0 1 1 0-5.27 
                                            2.635 2.635 0 0 1 0 5.27z" />
                                            </svg>
                                        </a>
                              ...
                              <div>
                                  <p className="text-base mt-2 font-semibold text-[#f8f9fa]">
                                      &copy; Copyright 2025. All Rights Reserved by ThinkShare.
                                  </p>
                              </div>
                          </div>
                      </div>
                      <div className="w-full p-6 md:w-1/2 lg:w-2/12">
                          <div className="h-full">
                              <h3 className="tracking-px mb-9  text-base font-semibold uppercase text-[#f8f9fa]">
                                  Company
                              </h3>
                              <ul>
                                  <li className="mb-3">
...
// YESTERDAYS CODE BEFORE ANY FINAL IMPROVEMENTS DONE
...
//                                   <li className="mb-4">
//                                       <Link
//                                           className=" text-sm font-medium text-[#e0e0e0] hover:text-[#ffffffcc]"
//                                           to="/"
//                                       >
//                                           Features
//                                       </Link>
